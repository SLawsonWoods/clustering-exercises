...
# def split_data(df):
#     '''
#     take in a DataFrame and return train, validate, and test DataFrames; stratify on logerror.
#     return train, validate, test DataFrames.
#     '''
    
#     # splits df into train_validate and test using train_test_split() stratifying on logerror to get an even mix 
#     train_validate, test = train_test_split(df, test_size=.2, random_state=123, stratify=df.logerror)
    
#     # splits train_validate into train and validate using train_test_split() stratifying on logerror to get an even mix 
...
def zillow_split(df):
    '''
    This function take in the zillow data acquired by get_zillow_data,
    performs a split and stratifies logerror column.
